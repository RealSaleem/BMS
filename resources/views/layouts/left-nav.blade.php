...
<style>
   .collapsible-sub .material-icons{
 ...
 <aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-dark sidenav-active-rounded">
        ...
        <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out" data-menu="menu-navigation" data-collapsible="accordion">
            ...
            <li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)"><i class="material-icons">supervisor_account</i><span class="menu-title" data-i18n="Invoice">User Management</span></a>
                <div class="collapsible-body">
                    <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                        <li><a href="{{route('user.index')}}"><i class="material-icons">account_circle</i><span data-i18n="Invoice List">User</span></a></li>
                        <li><a href="{{route('role.index')}}"><i class="material-icons">security</i><span data-i18n="Invoice List">Role</span></a></li>
